...
const AsciinemaList = ({ pageContext }) => {
  return (
    <div>
      <Navbar  backgroundColor='#7421fc' textColor='white'/>
      <main className="p-24 min-w-[768px] min-h-[500px] ">
        <div className="flex flex-col md:flex-row gap-10">
          <div className="flex-1">
            <div className="sticky top-[120px]">
              <div>
                <p className="text-sm font-bold uppercase text-purple-600">complete toolkit</p>
              </div>
              <div>
                <h3>
                  Make your site
