...
const Video = () => {
	...
	return (
		<div className='gsap-video px-8 min-h-fit w-[calc(100% - 60px)] flex flex-col '>
			{!isLogin && <div className='m-12 border-purple-700 border-[12px] bg-black rounded-lg  w-auto h-[240px] text-white font-bold flex justify-center items-center' > 请登录后方能观看视频</div >}
			<AsciinemaEditor
