...
const WatchVideo = () => {
  ...
  return (
    <div className="min-w-[768px] watch-the-video bg-[#f6f4ff] flex flex-col overflow-hidden p-24 justify-center items-center">
      <div className="flex flex-row gap-24 max-w-[1200px] w-full justify-center items-center">
        ...
        <div className="z-[1] flex-1 flex flex-col justify-center items-center h-[360px] p-12 relative rounded-xl shadow-md overflow-hidden">
          ...
          <div className="z-[2]">
            <div
              className="cursor-pointer py-2 px-4 rounded-md shadow-md bg-white flex flex-row gap-3 justify-center items-center"
            >
              <PlayCircle fontSize="12px"  onClick={playVideo}/>
