  ...
  return (
    <div className='watch-the-video bg-[#f6f4ff] flex flex-col overflow-hidden p-24 justify-center items-center'>
      <div className='flex flex-row gap-24 max-w-[1200px] w-full justify-center items-center'>
        <div className='video-content flex-[1.3] flex flex-col gap-10'>
          <div className='flex flex-col gap-6 justify-start items-start  max-w-[530px]'>
            <div >
              <p className='uppercase text-purple-700 font-extrabold text-sm'>complete toolkit</p>
            </div>
            <div >
              <h2 className='-tracking-wide'>Complete pages for your project.</h2>
            </div>
            <div >
              <p className='text-sm text-gray-600 font-medium'>Build a unique experience by mixing and matching components. Make your brand shine.</p>
            </div>
          </div>
        ...
        <div className='z-[1] flex-1 flex flex-col justify-center items-center h-[360px] p-12 relative rounded-xl shadow-md overflow-hidden'>
          <div className='absolute inset-0  select-none pointer-events-none'>
            <img className="h-full w-full" src="https://framerusercontent.com/images/d1xv23lohWIezwkwQogANBdUFa0.jpg" alt="" />
          </div>
          <div className='z-[2]'>
            <a onClick={playVideo}>
              <div className='cursor-pointer py-2 px-4 rounded-md shadow-md bg-white flex flex-row gap-3 justify-center items-center'>
                <PlayCircle fontSize='12px' />
