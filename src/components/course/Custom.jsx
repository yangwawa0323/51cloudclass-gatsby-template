			...
			>
				...
				<div className='flex flex-col max-w-[500px] items-center justify-center text-white gap-8'>
					...
					<div className='justify-center items-center flex flex-col'>
						<h2 className='text-[48px] text-white break-words font-extrabold'>
					...
					<div>
						<div>
							<form className='flex flex-row gap-10 items-center relative'>
								...
								<input
									className='text-gray-600 p-[15px] text-sm rounded-lg font-medium outline-none'
									type='email'
									name='email'
									vaule=''
								...
								<div>
									<input
										className='p-[15px] border-none rounded-lg text-white bg-black text-sm duration-500  hover:text-gray-400'
										value='subscribe'
										type='submit'
									/>
								</div>
