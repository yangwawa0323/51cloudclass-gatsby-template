		...
		<Frame>
			...
			<div className='min-w-[425px] about-us pt-[180px] px-[100px] pb-[100px] flex flex-col gap-20 justify-center items-center'>
				<div className='flex flex-col gap-4 justify-center items-center max-w-[720px]'>
					...
					<div>
						<p className='break-words text-gray-500 text-center tracking-[0.2px] font-medium text-[24px]'>
							Quickly assemble pages from various categories that you can
				...
				<div className='max-w-[1200px]  overflow-hidden rounded-2xl shadow-md'>
					<div>
						<div>
							<img
								alt=''
								src='https://framerusercontent.com/images/x8MsMLzPw4oCKSmMNOuZy76n2Is.jpg'
							/>
						</div>
					</div>
				</div>
			...
			<div className='min-w-[425px] our-term w-full flex flex-col gap-24 p-24 justify-center items-center'>
				<div className='flex flex-col gap-4 justify-center items-center max-w-[650px]'>
					...
					<p className='text-center text-gray-700 font-medium'>
						Combine sections from a range of categories to easily assemble pages
					...
					<div className='rounded-2xl shadow-md bg-gray-100 p-10 items-center justify-center flex flex-col'>
						<div className='hover:rotate-12 duration-500 aspect-[1/1] w-[128px]'>
							<div>
								<div>
									<img
										src='https://framerusercontent.com/images/F88dvZyjdx2hORzA9g7IjaYXezg.png'
										alt='Memoji'
									/>
								</div>
							</div>
					...
					<div className='rounded-2xl shadow-md bg-gray-100 p-10 items-center justify-center flex flex-col'>
						<div className='hover:rotate-12 duration-500 aspect-[1/1] w-[128px]'>
							<div>
								<div>
									<img
										src='https://framerusercontent.com/images/b1FbyNp7YdgmjybcyXXCV3zY3rE.png'
										alt='Memoji'
									/>
								</div>
							</div>
					...
					<div className='rounded-2xl shadow-md bg-gray-100 p-10 items-center justify-center flex flex-col'>
						<div className='hover:rotate-12 duration-500 aspect-[1/1] w-[128px]'>
							<div>
								<div>
									<img
										src='https://framerusercontent.com/images/MhvXK2BgzXfSUPIgRCv56eWI.png'
										alt='Memoji'
									/>
								</div>
							</div>
			...
			<div className='min-w-[425px] our-office bg-gray-100 w-full p-24 flex flex-col justify-center items-center gap-20'>
				<div className='flex flex-col gap-4 justify-center items-center max-w-[560px]'>
					...
					<h2 className='text-center break-words'>
					...
					<div className='rounded-[20px] shadow-lg hover:shadow-xl  bg-white p-8'>
						<div className='flex flex-col gap-8'>
							...
							<div className='flex flex-col gap-4'>
								<h4>Amsterdam </h4>
								<p className='whitespace-pre-wrap max-w-[60%] text-sm font-medium text-gray-500'>
			...
			<div className='min-w-[425px] our-mission flex flex-col lg:flex-row  gap-24 p-24'>
				...
				<div className='flex-1 grid grid-cols-[repeat(2,minmax(200px,1fr))]  max-w-[570px] grid-rows-[repeat(2,min-content)] gap-4 h-min justify-center'>
					...
					<div className='rounded-[10px] overflow-hidden opacity-80 hover:opacity-100 duration-700 shadow-lg hover:shadow-xl'>
						<img
							alt=''
							className='object-cover  h-[275px] w-[299px]'
							src='https://framerusercontent.com/images/xTJots53J1tNU5byXL7DoqNrQJc.jpg'
						/>
					</div>
					<div className='rounded-[10px] overflow-hidden opacity-80 hover:opacity-100 shadow-lg hover:shadow-xl'>
						<img
							alt=''
							className=' object-cover h-[275px] w-[299px]'
							src='https://framerusercontent.com/images/9wXcOZ9Y104tkWF0G0qyPSENWys.jpg'
						/>
					</div>
				</div>
			</div>
			...
			<div className='min-w-[425px] scrolling-up try-it-now flex flex-col gap-12 p-[100px] justify-center items-center bg-[#7421fc]'>
				<div className='max-w-[600px] flex flex-col justify-center items-center'>
					...
					<h2 className='text-center text-white break-words'>
						Build a website that performs better.
					</h2>
				</div>
				<div>
					<form className='flex md:flex-row xs:flex-col items-center gap-4'>
						<input
							className='
              p-4 bg-[rgba(255,255,255,0.2)] outline-none border-none rounded-lg text-gray-200 xs:w-[360px] w-[440px]
              '
